...
/**
 * Servlet implementation class QnaAllSelectController
 */
@WebServlet("/qnaAll.pq")
public class QnaAllSelectController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QnaAllSelectController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  request.setAttribute("pno", pno);
	   ...
	   request.getRequestDispatcher("views/userQnaBoard/qnaAllselectPage.jsp").forward(request, response);
	}
