...
public class ProductSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new ProductService().selectSearchCount(keyword);
		...
		ArrayList<Product> list = new ProductService().selectSearchList(keyword,pi);
		...
		request.getRequestDispatcher("views/selectProduct/productSearchPage.jsp").forward(request, response);
	}
