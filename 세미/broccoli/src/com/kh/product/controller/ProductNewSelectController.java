...
/**
 * Servlet implementation class ProductNewSelectController
 */
@WebServlet("/newProduct.pb")
public class ProductNewSelectController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductNewSelectController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  ArrayList<Product> list = new ProductService().selectNewProduct(pi);
	  ...
	  request.setAttribute("list", list);
		...
		request.getRequestDispatcher("views/selectProduct/productNewSelectPage.jsp").forward(request, response);
	}
