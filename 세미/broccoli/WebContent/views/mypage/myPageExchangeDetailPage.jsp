 ...
 <%@ include file="../common/menubar.jsp"%>
    ...
    <div class="wrap">
        ...
        <div id="content">
           ...
           <h3>반품/ 교환 조회 >교환</h3>
            <hr><p class="p">*필수입력</p><h4>&nbsp;&nbsp;&nbsp;&nbsp;1.교환요청 상품선택 </h4><hr class="line">
            <table class="table">
               <tr>
             ...
             <div class="reason"> 사유선택:
                <select name="reason" class="select">
                    <option value="select">사이즈변경</option>
                    <option value="trouble">상품불량</option>
                    <option value="style">색상변경</option>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">교환수거 정보입력</h4>
        ...
        <div class="modal-body">
            <table class="table1">
             ...
             <p class="p2">수거 주소 변경 및 수거취소 요청은 수거요청하신 택배사를 통해 진행</p><p class="p1">해주세요.</p></td></tr>
               ...
               <tr><td id="third"><br><h5>교환상품 택배정보입력</h5><br>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">교환철회</button>
          <button type="button" class="btn btn-success" data-dismiss="modal">교환신청</button>
        </div>
