...
<body>
    ...
    <div class="wrap">
        <div id="header">
            <div id="header_1" align="center"><h1>베스트</h1></div>
   ...
   <br><br>
            <div id="pagingBar" align="center">
                ...
                <%if(pi.getCurrentPage() != 1) { %>
                	<li class="page-item">
                    <a class="page-link" href="<%=broccoli%>/bestProduct.pb?currentPage=<%=pi.getCurrentPage() -1%>">&lt;이전</a>
                    </li>
                <% } %> 
                ...
                <%for(int p = pi.getStartPage(); p<pi.getEndPage(); p++) {%>
                    ...
                    <a class="page-link" href="<%=broccoli%>/bestProduct.pb?currentPage=<%=p%>"><%=p%></a>
                ...
                <%if(pi.getCurrentPage() != pi.getMaxPage())  {%>
                   <li class="page-item">
                    <a class="page-link" href="<%=broccoli%>//bestProduct.pb?currentPage=<%=pi.getCurrentPage() +1%>">&gt;다음</a>
                   </li>
                 <% } %>   
				</ul>
            </div>
